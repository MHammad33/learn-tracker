          ...
          <CardContent className="space-y-6 relative">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                ...
                />
                <Button onClick={addTag} size="sm" className="bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 border-0 rounded-xl px-4">
              ...
              {tags.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag, index) => (
                    <Badge key={index} className="gap-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white border-0 rounded-full px-3 py-1 hover:from-blue-600 hover:to-purple-600 transition-all">
                      {tag}
                      <X 
            ...
            {savedEntry ? (
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 p-6 rounded-xl border border-green-200 dark:border-green-800">
                  <p className="text-base leading-relaxed text-gray-700 dark:text-gray-300">{savedEntry.content}</p>
                </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {savedEntry.tags.map((tag, index) => (
                          <Badge key={index} className="bg-gradient-to-r from-green-500 to-blue-500 text-white border-0 rounded-full px-3 py-1">
                            {tag}
                          </Badge>
                        ))}
                      </div>
              ...
              <div className="text-center py-12">
                <div className="bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-xl p-8 border-2 border-dashed border-gray-300 dark:border-gray-600">
                  <p className="text-lg font-medium text-muted-foreground mb-2">No entry for today yet.</p>
                  <p className="text-base text-muted-foreground">Start by adding what you learned!</p>
