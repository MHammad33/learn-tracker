...
import { Book, Settings, Flame } from "lucide-react"
      ...
      <div className="px-4 md:px-8 lg:px-12 xl:px-16 2xl:px-20 flex h-16 items-center max-w-7xl mx-auto">
        ...
        <div className="flex flex-1 items-center justify-between space-x-4">
          ...
          <nav className="flex items-center space-x-2">
            <Button variant="ghost" size="sm" asChild className="hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-950 dark:hover:to-purple-950">
